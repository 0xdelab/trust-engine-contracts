...
contract ProcessRegistry {
    ...
    event ProcessSigned(bytes32 processId, bytes32 fromHash, bytes32 toHash, bytes32 signer, bytes32 signature, string metadata);
    ...
    function sign(
        ...
        emit ProcessSigned(processId, fromHash, toHash, signer, signature, metadata);
    }
